...
import twitter from './images/twitter-about.png'
import discord from './images/discord-about.png'
import instagram from './images/instagram-about.png'
...
export default function About(){
    ...
    return(
        <div className='about-actual-wrapper'>
            <div className='about-back-button' onClick={() => {
                    navigate('/')
                }}>
                Back!
            </div>
            ...
            <div className='about-photo-to-guess-wrapper'>
                <img src={photoToGuess} className='about-photo-to-guess'/>
            </div>
            
            <div className='about-wrapper'>
                <div className='about-images-wrapper'>
                    <img src={discord} className='about-image-link' onClick={() => {
                        window.open('https://discord.gg/Fhud4kzYEH')
                    }}/>                  


                </div>
                <div className='about-paragraph-test'>
                    If you would like to contact me, join the discord!
