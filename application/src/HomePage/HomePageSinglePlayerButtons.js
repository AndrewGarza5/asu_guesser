...
import './styles/home-page-single-player-buttons.css'
...
export default function HomePageSinglePlayerButtons(props){
    ...
    useEffect(() => {
      setTimeout(()=>{
        document.getElementById('home-screen-single-player-buttons-wrapper').style.transform = 'translateX(0)'
      }, 10)
    }, [])
    ...
    return(
      <>
        ...
        <div id='home-screen-single-player-buttons-wrapper' className='home-screen-single-player-buttons-wrapper'>
